define("UsrRealty_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common", "css!UsrRealtyFormPageCSS"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_yplsjy9_caption)#",
					"color": "default",
					"disabled": false,
					"size": "medium",
			...
			{
				"operation": "insert",
				"name": "RunExampleProcessMenuItem",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(RunExampleProcessMenuItem_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.RunBusinessProcessRequest",
						"params": {
							"processName": "UsrSimpleCSharpExampleProcess",
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var offerTypeObject = await request.$context.PDS_UsrOfferType_zg0mnje;
					var offerTypeId = "";
					if (offerTypeObject) {
